...
export interface TeamMember {
  ...
  bio?: string;
  socialLinks?: {
    type: 'linkedin' | 'twitter' | 'facebook' | 'instagram' | 'email';
    url: string;
  }[];
}
                ...
                <div className="aspect-[3/4] w-full">
                  {member.headshotUrl ? (
                    ...
                    <div className="w-full h-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center">
                      <svg className="h-20 w-20 text-gray-400 dark:text-gray-500" fill="currentColor" viewBox="0 0 24 24">
                ...
                {member.socialLinks && member.socialLinks.length > 0 && (
                  <CardFooter className="flex justify-center space-x-3 pt-0 pb-6">
                    {member.socialLinks.map((link, i) => (
                      ...
                      >
                        {socialIcons[link.type] || socialIcons.linkedin}
                      </a>
                    ))}
                  </CardFooter>
                )}
